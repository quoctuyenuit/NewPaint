        ...
        protected override Bitmap generateImage()
        {
            ...
            else
            {
                using (Graphics gr = Graphics.FromImage(bmp))
                {
                    ...
                    Point p1 = new Point(rightBound, halfVertical + upperBound);
                    Point p2 = new Point(rightBound, halfVertical * 3 + upperBound);
                    ...
                    Point p5 = new Point(leftBound, halfVertical * 2 + upperBound);
